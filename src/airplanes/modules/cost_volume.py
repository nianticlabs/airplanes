...
from airplanes.modules.networks import MLP
from airplanes.utils.generic_utils import combine_dims, tensor_B_to_bM, tensor_bM_to_B
from airplanes.utils.geometry_utils import (
    BackprojectDepth,
    Project3D,
    get_camera_rays,
    pose_distance,
...
class CostVolumeManager(nn.Module):
    ...
    def generate_depth_planes(
        ...
        """
        linear_ramp_bd11 = self.linear_ramp_1d11.expand(  # type: ignore
            batch_size,
            self.num_depth_bins,
            1,
            1,
